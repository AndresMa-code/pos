    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                ...
                <div>
                    <a href="{{ route('suppliers.create') }}" class="btn bg-indigo add-list"><i class="fa-solid fa-plus mr-3"></i>Add Supplier</a>
                    <a href="{{ route('suppliers.index') }}" class="btn bg-indigo add-list" style="color: rgb(114, 94, 168); border: 2px solid #4B0082; background-color: transparent; transition: background-color 0.3s;">
