                ...
                <div class="card-header d-flex justify-content-between bg-primary">
                    ...
                    <div class="invoice-btn d-flex">
                        <form action="{{ route('pos.printInvoice') }}" method="post">
                            ...
                            <button type="submit" class="btn btn bg-indigo mr-2"><i class="las la-print"></i> Print</button>
                        </form>

                        <button type="button" class="btn btn bg-indigo mr-2" data-toggle="modal" data-target=".bd-example-modal-lg">Create</button>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control @error('pay') is-invalid @enderror" id="pay" name="pay" value="{{ old('pay') }}" required>
                                                    @error('pay')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><span class="badge" style="background-color: #4B0082; color: white;">Unpaid</span></td>
                                            <td>
