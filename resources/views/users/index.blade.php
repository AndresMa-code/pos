    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                ...
                <div>
                <a href="{{ route('users.create') }}" class="btn bg-indigo add-list"><i class="fa-solid fa-plus mr-3"></i>Create User</a>
                <a href="{{ route('users.index') }}" class="btn bg-indigo add-list" style="color: rgb(114, 94, 168); border: 2px solid #4B0082; background-color: transparent; transition: background-color 0.3s;">
                        ...
                        <tr>
                            ...
                            <td>
                                @foreach ($item->roles as $role)
                                    <span class="badge bg-indigo">{{ $role->name }}</span>
                                @endforeach
                            </td>
                            <td>
                                <form action="{{ route('users.destroy', $item->username) }}" method="POST" style="margin-bottom: 5px">
                                    ...
                                    <div class="d-flex align-items-center list-action">
                                        ...
                                        <a class="btn bg-indigo mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="{{ route('users.edit', $item->username) }}"><i class="ri-pencil-line mr-0"></i>
                                        </a>
