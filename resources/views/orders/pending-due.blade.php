    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                ...
                <div>
                    <a href="{{ route('order.pendingDue') }}" class="btn bg-indigo add-list" style="color: rgb(114, 94, 168); border: 2px solid #4B0082; background-color: transparent; transition: background-color 0.3s;">
                ...
                <table class="table mb-0">
                    ...
                    <tbody class="ligth-body">
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="btn text-white" style="background-color: indigo; border: 2px solid indigo;">
                                    {{ $order->pay }}
                                </span>
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="d-flex align-items-center list-action">
                                    <a class="btn btn-info mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Details"
                                        href="{{ route('order.orderDetails', $order->id) }}" style="color: white; background-color: indigo; border: 2px solid indigo;">
                                        Details
                                    </a>
                                    <button type="button" class="btn mr-2" data-toggle="modal" data-target=".bd-example-modal-lg" id="{{ $order->id }}" onclick="payDue(this.id)" style="background-color: indigo; border: 2px solid indigo; color: white;">
                                        Pay Due
                                    </button>
                                </div>
                            </td>
        ...
        <div class="modal-content">
            <form action="{{ route('order.updateDue') }}" method="post">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn bg-indigo">Pay</button>
                </div>
            </form>
        </div>
    </div>
