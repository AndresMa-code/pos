    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                ...
                <div>
                    <a href="{{ route('order.pendingOrders') }}" class="btn bg-indigo add-list" style="color: rgb(114, 94, 168); border: 2px solid #4B0082; background-color: transparent; transition: background-color 0.3s;">
                ...
                <table class="table mb-0">
                    ...
                    <tbody class="ligth-body">
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="badge" style="background-color: indigo; color: white;">{{ $order->order_status }}</span>
                            </td>
                            <td>
                                <div class="d-flex align-items-center list-action">
                                    <div class="d-flex align-items-center list-action">
                                        ...
                                        <a class="btn btn-success mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Print" href="{{ route('order.invoiceDownload', $order->id) }}"
                                            style="color: white; background-color: rgb(35, 21, 116); border: 2px solid red;">
                                            Print
                                        </a>
                                </div>
                            </td>
