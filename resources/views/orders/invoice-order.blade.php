            ...
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <div class="invoice-info">
                            <div class="row">
                                ...
                                <div class="col-sm-6 text-end mb-50">
                                    ...
                                    <p class="inv-from-1">possystem@Compucenter.com</p>
                                    <p class="inv-from-2">Bogota, Colombia</p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6 mb-50">
                    ...
                    <div class="invoice-btn-section clearfix d-print-none">
                        <a href="javascript:window.print()" class="btn btn-lg btn-print" style="background-color: #4B0082; color: white;">
                            Print Invoice
                        </a>
                        <a id="invoice_download_btn" class="btn btn-lg btn-download" style="background-color: #4B0082; color: white;">
                            Download Invoice
                        </a>
                    </div>
                </div>
