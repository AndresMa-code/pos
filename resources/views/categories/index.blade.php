    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                ...
                <div>
                <a href="{{ route('categories.create') }}" class="btn btn bg-indigo add-list"><i class="fas fa-plus mr-3"></i>Create Category</a>
                <a href="{{ route('categories.index') }}" class="btn bg-indigo add-list" style="color: rgb(114, 94, 168); border: 2px solid #4B0082; background-color: transparent; transition: background-color 0.3s;">
