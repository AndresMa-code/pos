    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                ...
                <div>
                <a href="{{ route('employees.create') }}" class="btn btn bg-indigo add-list"><i class="fa-solid fa-plus mr-3"></i>Add Employee</a>
                <a href="{{ route('employees.index') }}" class="btn btn bg-indigo add-list" style="color: rgb(114, 94, 168); border: 2px solid #4B0082; background-color: transparent; transition: background-color 0.3s;">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <button type="submit" class="btn add-list" style="color: white; border: 2px solid #4B0082; background-color: #4B0082; transition: background-color 0.3s;">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center list-action">
                                    <a class="badge bg-indigo mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="View"
                                        href="{{ route('employees.show', $employee->id) }}"><i class="ri-eye-line mr-0"></i>
                                    </a>
                                    <a class="badge bg-indigo mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"
                                    ...
                                    <form action="{{ route('employees.destroy', $employee->id) }}" method="POST" style="margin-bottom: 5px">
                                        @method('delete')
                                        @csrf
                                        <button type="submit" class="badge bg-indigo mr-2 border-none" onclick="return confirm('Are you sure you want to delete this record?')" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><i class="ri-delete-bin-line mr-0"></i></button>
                                    </form>
                                </div>
                            </td>
                        </tr>
