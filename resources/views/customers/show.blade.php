                ...
                <div class="card-body">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="ml-3">
                            ...
                            <a href="{{ route('customers.edit', $customer->id) }}" class="btn btn bg-indigo font-size-14">Edit</a>
                            <a href="{{ route('customers.index') }}" class="btn btn bg-indigo font-size-14">Back</a>
                        </div>
                    </div>
