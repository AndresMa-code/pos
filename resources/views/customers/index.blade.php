    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                ...
                <div>
                    <a href="{{ route('customers.create') }}" class="btn bg-indigo add-list"><i class="fa-solid fa-plus mr-3"></i>Add Customer</a>
                    <a href="{{ route('customers.index') }}" class="btn bg-indigo add-list" style="color: rgb(114, 94, 168); border: 2px solid #4B0082; background-color: transparent; transition: background-color 0.3s;">
