        ...
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    ...
                    <p class="mb-0">An in-stock dashboard allows you to easily collect and visualize information about available products, <br>
                        facilitating efficient inventory management. This optimizes the in-stock experience and ensures proper retention </p>
                </div>
            </div>
        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="input-group col-sm-8">
                            ...
                            <div class="input-group-append">
                                ...
                                <a href="{{ route('order.stockManage') }}" class="input-group-text bg-indigo">
                ...
                <table class="table mb-0">
                    ...
                    <tbody class="ligth-body">
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="btn text-white mr-2" style="background-color: indigo; border: 2px solid indigo;">
