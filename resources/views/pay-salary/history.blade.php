                ...
                <table class="table mb-0">
                    ...
                    <tbody class="ligth-body">
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="btn bg-indigo text-white mr-2">Full Paid</span>
                            </td>
                            <td>
                                <form action="{{ route('pay-salary.destroy', $paySalary->id) }}" method="POST">
                                    ...
                                    <div class="d-flex align-items-center list-action">
                                        <a class="btn bg-indigo mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="History" href="{{ route('pay-salary.payHistoryDetail', $paySalary->id) }}">
