        ...
        <nav class="navbar navbar-expand-lg navbar-light p-0">
            <div class="iq-navbar-logo d-flex align-items-center justify-content-between">
                ...
                <a href="{{ route('dashboard') }}" class="header-logo">
                    <img src="../assets/images/images.pos.png" class="img-fluid rounded-normal" alt="logo">
                    <h5 class="logo-title ml-3" style="color: #140e83;">Pos System</h5>
                </a>
            </div>
            <div class="iq-search-bar device-search">
                <div class="search-blocked-message">
                    <p>Search is blocked!</p>
                </div>
                <form action="#" class="searchbox">
                    <a class="search-link" href="#"><i class="ri-search-line"></i></a>
                    <input type="text" class="text search-input" placeholder="Find data here..." disabled>
                </form>
            </div>
